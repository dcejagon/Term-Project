\hypertarget{classcotask_1_1Task}{}\doxysection{cotask.\+Task Class Reference}
...
\item 
def \mbox{\hyperlink{classcotask_1_1Task_a912aa5a1bed736fa76e110ab0448e97b}{\+\_\+\+\_\+init\+\_\+\+\_\+}} (self, run\+\_\+fun, \mbox{\hyperlink{classcotask_1_1Task_ab54e069dd0b4f0a2f8e7f00c94998a10}{name}}=\char`\"{}No\+Name\char`\"{}, priority=0, \mbox{\hyperlink{classcotask_1_1Task_a44f980f61f1908764c6821fa886590ca}{period}}=None, profile=False, trace=False)
\begin{DoxyCompactList}\small\item\em ! Initialize a task object so it may be run by the scheduler. \end{DoxyCompactList}\item 
bool \mbox{\hyperlink{classcotask_1_1Task_af60def0ed4a1bc5fec32f3cf8b8a90c8}{schedule}} (self)
...
bool \mbox{\hyperlink{classcotask_1_1Task_a6102bc35d7cb1ce292abc85d4ddc23e1}{ready}} (self)
...
\mbox{\Hypertarget{classcotask_1_1Task_aeced93c7b7d23e33de9693d278aef88b}\label{classcotask_1_1Task_aeced93c7b7d23e33de9693d278aef88b}} 
{\bfseries priority}
...
\end{DoxyCode}
 def task1\+\_\+fun ()\+: \textquotesingle{}\textquotesingle{}\textquotesingle{}! This function switches states repeatedly for no reason \textquotesingle{}\textquotesingle{}\textquotesingle{} 
\begin{DoxyCode}{0}
...
\DoxyCodeLine{task1 = \mbox{\hyperlink{classcotask_1_1Task}{cotask.Task}} (task1\_fun, name = \textcolor{stringliteral}{'Task 1'}, priority = 1,}
...
\end{DoxyCode}
 while True\+: cotask.\+task\+\_\+list.\+pri\+\_\+sched ()  

\doxysubsection{Constructor \& Destructor Documentation}
\mbox{\Hypertarget{classcotask_1_1Task_a912aa5a1bed736fa76e110ab0448e97b}\label{classcotask_1_1Task_a912aa5a1bed736fa76e110ab0448e97b}} 
...
It shows information about the task, including execution time profiling results if profiling has been done. \mbox{\Hypertarget{classcotask_1_1Task_a6e51a228f985aec8c752bd72a73730ae}\label{classcotask_1_1Task_a6e51a228f985aec8c752bd72a73730ae}} 
...
This method may be called from an interrupt service routine or from another task which has data that this task needs to process soon. \mbox{\Hypertarget{classcotask_1_1Task_a6102bc35d7cb1ce292abc85d4ddc23e1}\label{classcotask_1_1Task_a6102bc35d7cb1ce292abc85d4ddc23e1}} 
...
This method is also used by {\ttfamily {\bfseries{init}}}() to create the variables. \mbox{\Hypertarget{classcotask_1_1Task_af60def0ed4a1bc5fec32f3cf8b8a90c8}\label{classcotask_1_1Task_af60def0ed4a1bc5fec32f3cf8b8a90c8}} 
...
If the period is {\ttfamily None}, the {\ttfamily run()} method won\textquotesingle{}t be run on a time basis but will instead be run by the scheduler as soon as feasible after code such as an interrupt handler calls the {\ttfamily \mbox{\hyperlink{classcotask_1_1Task_a78e74d18a5ba94074c2b5309394409a5}{go()}}} method. 
