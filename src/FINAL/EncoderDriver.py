...
class EncoderDriver:
    ...
    def __init__(self,ENCpin1,ENCpin2,ENC2pin1,ENC2pin2,timernumber,timernumber2,EncPosition1,EncPosition2):
        ...
        #                   previous encoder count, used in calculating delta
        self.countprev2=0
        ## @brief           Defines the curent encoder 1 position
        #  @details         This variable keeps track of the current encoder 1 position; shared. 
        #                   We share this position between files to keep track of encoder 1 position
        self.EncPosition1 = EncPosition1
        ## @brief           Defines the curent encoder 2 position
        #  @details         This variable keeps track of the current encoder 2 position; shared. 
        #                   We share this position between files to keep track of encoder 1 position
        self.EncPosition2 = EncPosition2
        ## @brief           Defines the curent encoder 1 position 
        #  @details         This variable keeps track of the current encoder 1 position; temporary
        self.position1=0
        ## @brief           Defines the curent encoder 2 position 
        #  @details         This variable keeps track of the current encoder 2 position; temporary
        self.position2=0
        ...
        ## @brief            Defines the location of the encoder1 timer channel on the Nucleo
        #  @details          Defines the location of the encoder1 timer channel on the Nucleo
        #                    as channel 1
        ...
        ## @brief            Defines the location of the encoder2 timer channel on the Nucleo
        #  @details          Defines the location of the encoder2 timer channel on the Nucleo
        #                    as channel 1
    ...
    def read(self):
        ''' @brief Reads encoder 1 position
